...
.controller('FirmlistsCtrl', function($scope, $firebase, $ionicLoading) {
...
.controller('FirmlistCtrl', function($scope, $stateParams, $firebase, $ionicLoading) {
...
.controller('MapCtrl', function($scope, $stateParams, $firebase, $ionicLoading) {
  var geocoder;
...
function getLatLngByAddress(map) {
  $scope.map = map;
  var address = "Tomelilla, Östergatan 19";
